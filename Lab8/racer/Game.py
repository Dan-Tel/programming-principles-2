...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("Lab8\\racer\images\Coin.png")
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound('Lab8\\racer\\audio\crash.wav').play()
          time.sleep(1)
        ...
        pygame.mixer.Sound('Lab8\\racer\\audio\coin.mp3').play()
        # for coin in coins:
            # coin.collect()
        C1.collect()
        C1.rect.top = 0
